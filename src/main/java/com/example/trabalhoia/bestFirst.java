...
import static com.example.trabalhoia.HelloController.listaNosB;
...
public class bestFirst {
    ...
    public bestFirst(int[][] mat, Button[][] matF, int nivel, int x, int y,List<Integer> listaI,List<int[][]> visitados) {
        this.mat = mat;
    ...
    public void resolver(){
        ...
        if (y + 1 < HelloController.matY) {
            ...
            if(!contem(matAux,visitados))
                listaNosB.add(new noB(matAux, listaI, x, y + 1,visitados));
        ...
        if (x + 1 < HelloController.matX) {
            ...
            if(!contem(matAux,visitados))
                listaNosB.add(new noB(matAux, listaI, x + 1, y,visitados));
